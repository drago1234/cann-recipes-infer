...
#
# This code is based on xDiT Team's xDiT library and the xfuser
# implementations in this library. It has been modified from its
# original forms to accommodate minor architectural differences compared
# to xfuser used by xDiT Team.
#
...
################################################
# This code is based on xfuser 0.4.4
# Replace xfuser/envs.py of this code.

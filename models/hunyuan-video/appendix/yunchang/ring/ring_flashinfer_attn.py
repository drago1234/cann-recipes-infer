...
# Copyright [2024] [feifeibear (Jiarui Fang)]. All rights reserved.
#
# This code is based on feifeibear's long-context-attention library and the long-context-attention
# implementations in this library. It has been modified from its
# original forms to accommodate minor architectural differences compared
# to long-context-attention used by feifeibear.
#
...
################################################
# This code is based on yunchang 0.6.3.post1
# Replace yunchang/ring/ring_flashinfer_attn.py of this code.

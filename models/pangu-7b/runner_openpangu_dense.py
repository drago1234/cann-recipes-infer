...
class PanguEmbeddedRunner(ModelRunner):
    ...
    def model_generate(self, prompts, warm_up=False):
        ...
        # get init input_dict
        #  attenMask shape must be (2048, 2048) or (1, 2048, 2048) or (1, 1, 2048, 2048) when sparse mode = 2, but now it's (4096, 4096).[FUNC:CheckMaskShapeCrossSparse][FILE:prompt_flash_attention_tiling_v2.cpp][LINE:1455]

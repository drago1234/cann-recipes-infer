...
class PanguEmbeddedConfig(PretrainedConfig):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        num_hidden_layers = _first_not_none(num_hidden_layers, kwargs.pop("n_layer", None), kwargs.pop("num_layers", None))
        num_attention_heads = _first_not_none(num_attention_heads, kwargs.pop("n_head", None), kwargs.pop("num_heads", None))
